...
public class LoansServiceImpl implements LoansService {
    ...
    public void createLoan(String mobileNumber) {
        loansRepository.findByMobileNumber(mobileNumber)
                .ifPresent(l -> {
                    throw new RuntimeException("Loan already exists for the given mobile number" + l.getMobileNumber());
                });
    ...
    public boolean updateLoan(LoansDto loansDto) {
        Loans loans = loansRepository.findByLoanNumber(loansDto.getLoanNumber())
                .orElseThrow(() -> new ResourceNotFoundException("Loan", "LoanNumber", loansDto.getMobileNumber()));
